...
print("Введите частоту записи в часах (каждый час - два - пять и т.д.")
...
while start_date <= end_date:
    ...
    try:
        ...
        f = open(path, 'wb')
        f.write(urllib.request.urlopen("https://172.31.176.3:8080/jit-export-download?sid=" + sid + "&task_id=" + task_id).read())
        f.close()
        #запись файла
